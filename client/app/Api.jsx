...
class Api {
  ...
  postParagraphsInsert(documentId, sentences, position, rank, success, failure) {
    const data = {DocumentId: documentId, sentences: sentences, position: position, rank: rank};
